...
- [#59](https://github.com/omnidotdev/rdk/pull/59) [`584773c`](https://github.com/omnidotdev/rdk/commit/584773c90dc280fd9534d5b4165950fcca446068) Thanks [@coopbri](https://github.com/coopbri)! - Add `GeoLine` and `GeoPolygon` components for rendering paths and areas in AR space using lon/lat coordinates. These components complete the core GeoJSON geometry support:
